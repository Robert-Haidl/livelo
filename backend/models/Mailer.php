...
class Mailer{
    ...
    public function sendFragenkatalogMailToCustomer($data){
        ...
        try {
            ...
            .'<img src="https://livelo.at/res/images/logo.png" style="max-width: 300px; width: 100%;">'
            .'<br>'
            .'<h3>Danke Frau Prof. '.$lastname.', dass Sie Interesse an unserem Bohrführerscheinkurs haben!</h3>'
            .'<br>'
            .'<h3>Aufgrund von vielen Anfragen kann es bis zu 2 Werktagen dauern, bis Sie Ihren Fragenkatalog erhalten!'
            .'<br>'
            .'Wir werden Ihre Anfrage so schnell wie möglich bearbeiten und melden uns bei Ihnen in Kürze.'
            .'</h3>'
            .'<br>'
